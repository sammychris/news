    ...
    <>
      <div className={styles.collectionHeaderBG}>
        <header className={styles.collectionHeader}>
          <h1>Trending</h1>
          <p>
            Stay ahead of the game with Verge Trending, your go-to source for
      ...
      <div className={styles.container}>
        <ViewMoreButton title="View More in Related News" link="/trending" />
      </div>
    </>
  );
};
